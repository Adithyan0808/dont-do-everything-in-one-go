function RegistrationErrorState({ title = 'Registration data unavailable', error, onRetry }) {
  return (
    <div className="rounded-card border border-red-200 bg-red-50 p-5 text-sm text-red-800">
      <p className="font-semibold">{title}</p>
      <p className="mt-1">We could not load this registration section. Please retry.</p>
...
export default RegistrationErrorState;
